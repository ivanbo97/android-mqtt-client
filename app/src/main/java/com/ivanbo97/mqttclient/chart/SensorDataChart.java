package com.ivanbo97.mqttclient.chart;
...
public class SensorDataChart implements OnChartValueSelectedListener {
    ...
    public SensorDataChart(LineChart lineChart) {
    ...
    private void demoChartInit(){
        lineChart.setData(lineData);
        lineChart.getDescription().setText("Sensor Data");
        ...
        lineChart.setNoDataText("Waiting for sensor data....");
